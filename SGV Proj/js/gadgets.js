const data= [
    {
        id : 0,
        img : './products/Gadgets_images/Boat Airdopes.png',
        name : 'Boat Airdopes',
        price : 12000,
        save : 2500,
    ...
    {
        id : 1,
        img : './products/Gadgets_images/Boat Bassheads.png',
        name : 'Boat Bassheads',
        price : 10000,
        save : 2000,
        delievery : 'In 3 - 4 days',
    ...
    {
        id : 2,
        img : './products/Gadgets_images/Boat Rockerz 450.png',
    ...
    {
        id : 3,
        img : './products/Gadgets_images/JBL Earphones.png',
        name : 'JBL Earphones',
        price : 8500,
        save : 500,
        delievery : 'In 3 - 4 days',
    ...
    {
        id : 4,
        img : './products/Gadgets_images/JBL Headphones.png',
        name : 'JBL Headphones',
        price : 7000,
        save : 1500,
        delievery : 'In 3 - 4 days',
    ...
    {
        id : 5,
        img : './products/Gadgets_images/JBL Speakers.png',
        name : 'JBL Speakers',
        price : 8000,
        save : 1000,
        delievery : 'In 3 - 4 days',
    ...
    {
        id : 6,
        img : './products/Gadgets_images/Oneplus band.png',
        name : 'Oneplus band',
        price : 6000,
        save : 500,
        delievery : 'In 3 - 4 days',
    ...
    {
        id : 7,
        img : './products/Gadgets_images/Oneplus Buds.png',
        name : 'Oneplus Buds',
        price : 15000,
        save : 3000,
        delievery : 'In 3 - 4 days',
